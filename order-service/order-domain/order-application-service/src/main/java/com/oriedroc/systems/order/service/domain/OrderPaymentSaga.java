...
import com.oriedroc.systems.order.service.domain.outbox.scheduler.approval.ApprovalOutboxHelper;
...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    private Order rollbackPaymentForOrder(PaymentResponse paymentResponse) {
        log.info("Cancelling order order with id: {}", paymentResponse.getOrderId());
        Order order =  orderSagaHelper.findOrder(paymentResponse.getOrderId());
    ...
    private OrderApprovalOutboxMessage getUpdatedApprovalOutboxMessage(String sagaId,
        ...
        if(orderApprovalOutboxMessageResponse.isEmpty()) {
            throw new OrderDomainException("Approval outbox message could not br found in " +
