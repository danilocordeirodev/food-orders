package com.oriedroc.systems.kafka.consumer.config;

import com.oriedroc.systems.kafka.config.data.KafkaConfigData;
import com.oriedroc.systems.kafka.config.data.KafkaConsumerConfigData;
