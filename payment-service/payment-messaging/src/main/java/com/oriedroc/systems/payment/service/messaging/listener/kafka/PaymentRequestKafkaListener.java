package com.oriedroc.systems.payment.service.messaging.listener.kafka;

import com.oriedroc.systems.kafka.consumer.KafkaConsumer;
import com.oriedroc.systems.kafka.order.avro.model.PaymentOrderStatus;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public void receive(@Payload List<PaymentRequestAvroModel> messages,
        ...
        log.info("{} number of payment requests received with key: {}, partitions: {} and offsets: {}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString());
