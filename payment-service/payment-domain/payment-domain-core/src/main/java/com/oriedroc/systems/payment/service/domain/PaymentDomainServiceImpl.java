...
import com.oriedroc.systems.payment.service.domain.valueobject.CreditHistoryId;
import com.oriedroc.systems.payment.service.domain.valueobject.TransactionType;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(Payment payment,
        ...
        updateCreditHstory(payment, creditHistories, TransactionType.DEBIT);
    ...
    public PaymentEvent validateAndCancelPayment(Payment payment,
        ...
        updateCreditHstory(payment, creditHistories, TransactionType.CREDIT);
        ...
        if (failureMessages.isEmpty()) {
            ...
            log.info("Payment cancelation is failed for order id: {}", payment.getOrderId().getValue());
            payment.updateStatus(PaymentStatus.FAILED);
            return new PaymentFailedEvent(payment, ZonedDateTime.now(ZoneId.of(UTC)), failureMessages,
                    paymentFailedEventDomainEventPublisher);
        }
    ...
    private void updateCreditHstory(Payment payment,
                                    List<CreditHistory> creditHistories,
